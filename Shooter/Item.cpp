...
void AItem::ItemInterp(float DeltaTime)
{
	...
	{
		//Elpased Time since we started ItemInterp 
		...
		//Adding curve value to the z component of Initial Location
...
void AItem::StartItemCurve(AShooterCharacter* Char, bool bForcePlaySound)
{
	...
	//Store a handle of the character
	Character = Char;
	...
	//Inital Yaw offset between Camera and Uaw
